...
while ($row = $result->fetch_assoc()) {
   ...
   // array_push($places, $place);
    ...
    if (!isset($sorted_items[$row['country_id']])) {
        $sorted_items[$row['country_id']] = array('places' => array(), 'events' => array());
    }
    $sorted_items[$row['country_id']]['places'][] = $place;
}
...
while ($row = $result->fetch_assoc()) {
    ...
    $sorted_items[$row['country_id']]['events'][] = $event;
}
...
foreach ($country_ids as $country_id) {
    ...
    $country = array(
        ...
        'show_regions' => $show_regions,
        'updated_at' => $row['updated_at'],
        'places' => isset($country_items[$row['id']]['places']) ? $country_items[$row['id']]['places'] : [],
        'events' => isset($country_items[$row['id']]['events']) ? $country_items[$row['id']]['events'] : [],
    );
    array_push($countries, $country);
}
