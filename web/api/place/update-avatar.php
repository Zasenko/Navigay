...
$sql = "SELECT Place.avatar as avatar, Place.owner_id, Place.added_by, Country.isoCountryCode as isoCountryCode FROM Place INNER JOIN Country ON Country.id = Place.country_id WHERE Place.id = ?";
$params = [$place_id];
$types = "i";
$stmt = executeQuery($conn, $sql, $params, $types);
