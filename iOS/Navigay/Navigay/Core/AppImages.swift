...
struct AppImages {
    ...
    static let iconPhoneFill = Image(systemName: "phone.fill")
    ...
    static let iconArrowDownLeft = Image(systemName:"arrow.down.left")
...
//    static let mapPartyIcon = UIImage(named: "partyIcon")
}
