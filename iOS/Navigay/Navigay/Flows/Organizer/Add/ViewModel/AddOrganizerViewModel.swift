...
final class AddOrganizerViewModel: ObservableObject {
    ...
    @Published var email: String = "sdfsdf@sdfg.ru"
  ...
  //  @Published var showEditView: Bool = false
    ...
    init(networkManager: EditOrganizerNetworkManagerProtocol, errorManager: ErrorManagerProtocol) {
