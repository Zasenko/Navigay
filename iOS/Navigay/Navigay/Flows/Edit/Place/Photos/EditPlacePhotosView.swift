...
//                            .padding()
//                            .padding(.bottom)
//                        EditLibraryView(photos: $viewModel.photos>, isLoading: $viewModel.libraryPhotoLoading, width: proxy.size.width { result in
...
////                                viewModel.deleteLibraryPhoto(from: user)
////                            }
////                        }
////                    } label: {
////                        ZStack {
