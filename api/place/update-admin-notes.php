...
sendError('is_checked: ' . $is_checked . ' / is_active: ' . $is_active . ' .');
...
$sql = "UPDATE Place SET admin_notes = ?, is_active = ?, is_checked = ? WHERE id = ?";
$params = [$admin_notes, $is_active, $is_checked, $place_id];
$types = "siii";
$stmt = executeQuery($conn, $sql, $params, $types);
