...
$sql = "SELECT Place.id, Place.main_photo as main_photo, Country.isoCountryCode as isoCountryCode FROM Place INNER JOIN Country ON Country.id = Place.country_id WHERE Place.id = ?";
$params = [$place_id];
$types = "i";
